...
import { SendMessage } from '../../Redux/SearchUser/searchUserSlice';
    ...
    return (
        ...
        {/* <form onSubmit={handleSend}> */}
            ...
            <div className="flex items-center px-3 py-2 rounded-lg bg-gray-200 ">
                ...
                <textarea id="chat" rows="3" className="block mx-2 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Type a message..." value={content} onChange={detectChange}></textarea>
