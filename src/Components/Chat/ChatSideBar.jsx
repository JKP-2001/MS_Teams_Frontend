...
const ChatSideBar = (props) => {
    ...
    return (
        ...
        <div>
            <div id='z-10  chatSideBar' className='fixed border-[#b7b3b36d] ml-3  md:left-[80px] top-[60px] w-[95%] md:w-[350px] flex flex-col bg-[#ffffff] min-h-screen border-r-2 shadow-xl border-2 rounded-md'>
                <div id='chatSideBarTop' className='flex items-center border-b-[1px] border-gray-300 p-4' style={{ "color": "#242424" }}>
                    <div className='w-1/2 justify-start px-3 font-semibold text-2xl'>
                        Chats
                    </div>
