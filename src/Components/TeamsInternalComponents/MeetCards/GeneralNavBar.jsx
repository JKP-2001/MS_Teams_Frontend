        ...
        <div className="teamsnav">
          <div className="assignmentcontainer justify-start pb-4 fixed translate-x-[352px] w-screen border-2 bg-[#f5f5f5] hidden min-[950px]:block my-2">
            <div className="grpimage ml-[40px] mt-[54px] flex space-x-4">
              ...
              {click === "member" ? <div className="name mt-1 cursor-pointer border-b-[2.5px] border-b-[#444791]" onClick={() => clickMember()}>Members</div> : <div className="name mt-1 cursor-pointer hover:border-b-[2.5px]" onClick={() => clickMember()}>Members</div>}
            </div>
          </div>
        </div>
      </div>
